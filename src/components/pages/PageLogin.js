...
export default function PageLogin() {
    return <div id="loginPage" className="bg-[#FFD370]">
        <div className="container mx-auto h-screen px-8 py-8 flex flex-col 
        items-center lg:w-3/4 xl:w-3/5 md:flex-row md:justify-between md:items-start md:py-24">
            ...
            <div className='w-3/5 md:w-72 md:justify-start'>
                <LoginForm />
            </div>
        </div>
    </div>
